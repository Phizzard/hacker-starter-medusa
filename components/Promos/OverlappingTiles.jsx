...
export default function OverlappingTiles() {
  return (
      ...
      <section aria-labelledby="collection-heading" className="relative -mt-96 sm:mt-0">
        ...
        <div className="mx-auto grid max-w-md grid-cols-1 gap-y-6 px-4 sm:max-w-7xl sm:grid-cols-3 sm:gap-y-0 sm:gap-x-6 sm:px-6 lg:gap-x-8 lg:px-8">
          {collections.map((collection) => (
            <div key={collection.name} className="group relative h-96 rounded-lg bg-white shadow-xl sm:aspect-w-4 sm:aspect-h-5 sm:h-auto">
              <div>
                ...
                <div className="absolute inset-0 flex items-end rounded-lg p-6">
                  <div>
                    ...
                    <h3 className="mt-1 font-thin text-white">
